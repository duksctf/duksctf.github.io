...
```
And we end up with the flag encoded as char numbers in an [audio file](/resources/2017/plaidctf/), we could easily listen it and translate it into the real flag:
